...
## the modules: https://github.com/MicrosoftLearning/AI-102-AIEngineer

Go to Readme:
Click the link below > Go to instruction folder > Click Exercise > Follow the instruction
...
4. You Will get an account for 120 minutes active
5. Go to Microsoft login
6. login with that account
7. Go explore and have fun!
